...
from .views import (
    DimensionListAPIView,
    ExportSurveyDataView,
...
urlpatterns = [
    ...
    path(
        "code/generate/", GenerateAccessCodeView.as_view(), name="generate-access-code"
    ),
    path(
        "code/list/<int:employee_id>/",
        ListAccessCodesByEmployeeView.as_view(),
        name="list-access-codes",
    ),
    path(
        "code/validate/", ValidateAccessCodeView.as_view(), name="validate-access-code"
    ),
    path(
        "statistics/<int:empresa_id>/",
    ...
    path(
        "recommendations/",
        SurveyRecommendationsView.as_view(),
